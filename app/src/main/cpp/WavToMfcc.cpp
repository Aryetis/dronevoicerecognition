...
* @return none
*/
void wavRead(FILE **p_wav, const char *filename, wavfile *p_header) {
...
/**
* Compute MFCC of a signalcd DOc
*
...
* @return none
*/
void computeMFCC(float **X_mfcc, int *length_xmfcc, int16_t *x, int Nx,
     int frequency, int frame_length, int frame_step, int dim_mfcc,
      int num_filter) {
